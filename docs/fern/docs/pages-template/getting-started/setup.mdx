...
<Info>
This is the setup guide for Next.js. If you are looking for the setup guide for vanilla JavaScript, check out the [JavaScript SDK Setup](../../pages-js/getting-started/setup.mdx).
</Info>

Most of the time we recommend using our **setup wizard**, which will automatically detect your project structure and guide you through the installation process. In case it fails, you can choose to do the manual installation instead.
...
<Tabs style={{backgroundColor: "black"}}>
  <Tab title="Setup wizard (recommended)">
    <Steps>
      ...
      If you are setting up a Next.js project, read on below. If you are setting up any other JavaScript project, read on on our [vanilla JavaScript guide](/getting-started/vanilla-js).
...
<Info>
This is the setup guide for Vanilla JavaScript SDK. If you are looking for the setup guide for Next.js, check out the [Next.js SDK Setup](../../pages-next/getting-started/setup.mdx).
</Info>
