...
Stack components support light and dark mode out of the box. All Stack UI components automatically adapt their colors, shadows, and contrast levels based on the selected theme.
